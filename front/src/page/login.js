                    ...
                    <div class="absolute top-24 left-0 h-36 w-full ">
                        <div class="box-border relative">
                            <div class="absolute top-1/10 left-0 w-full relative">
                                <p class="absolute left-12 ext-black-500 text-1xl">请输入账号/手机号:</p>
                            </div>
                            <br/>
                            <div class="h-2"></div>
                        ...
                        <div className="absolute top-24 h-1/3 left-0 w-full -mt-1">
                            ...
                            <div className="flex items-center justify-between">
                                <a href="./PassWord" class="text-blue-500 text-right ml-10 underline">忘记密码</a>
                                <a href="./JAccount"
                                   class="text-blue-500 text-right mr-12 underline">使用jaccount登录</a>
                            </div>
                        </div>
                    </div>
                </div>
