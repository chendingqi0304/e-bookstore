        ...
        async function fetchBook(link) {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    if (data.code === 1) {
                        data.data.originprice = data.data.originprice.toFixed(2);
                        data.data.price = data.data.price.toFixed(2);
                        setBook(data.data);
        ...
        <>
            ...
            <div class="w-full h-auto flex items-center justify-center">
                <div class="grid grid-cols-2 gap-20 pt-10 w-auto">
                    ...
                    <div class="h-auto w-2/3 p-5 leading-9 rounded-xl ring-2 ring-black ring-opacity-5">
                        <div class="text-3xl text-red-700">{book.title}</div>
                        <div class="text-gray-700">作者：{book.author}</div>
