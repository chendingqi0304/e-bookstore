...
import {GetCart, UpdateCart} from "../utils/CartAPI";
import {BuyByCartId} from "../utils/OrderAPI";
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (number, record, rowIndex) => (
                <Space size="middle">
                    <InputNumber min={1} max={1000} defaultValue={number}
                                 onChange={(e) => handleCellChange(rowIndex, 'number', e)}/>
                </Space>
            ),
        },
        {
